 ...
 */
function createHtmlFileForSection (sectionData, sectionName, allSections, parentSectionName, options, grunt, pages) {
  'use strict';
  ...
  currentPage.data.sections = allSections;
...
module.exports = function (params, callback) {
  ...
  for (var sectionKey in sections) {
    ...
    if (sectionKey === 'index') {
      ...
      createHtmlFileForSection(section, sectionKey, sections, sectionKey, options, grunt, pages);
    }
      ...
      for (var subSectionKey in section) {
        var subSection = section[subSectionKey];
        if (typeof(subSection) === 'object' && subSection.sectionName !== undefined) {
          createHtmlFileForSection(subSection, subSectionKey, sections, sectionKey, options, grunt, pages);
        }
      }
    }
  }
