module.exports.register = function (Handlebars) {
     ...
     * {{/ifReference}}
     */
    Handlebars.registerHelper('ifReferenceOfSection', function (section, options) {
    ...
    /**
     * @return get section with SECTIONNAME and all of her subsection from SECTIONS in buffer obj
     * */
    ...
    Handlebars.registerHelper('inclTeaserSize', function (teaserSize, options) {
        ...
        if (matchTeaser !== -1 && matchSize !== -1) {
            ...
            var sizesString = sizesString.join(" ");
            var sizesString = sizesString.replace("[", "");
            var sizesString = sizesString.replace("]", "");
